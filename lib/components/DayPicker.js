...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MenuMonthYear = __webpack_require__(46);

	var _MenuMonthYear2 = _interopRequireDefault(_MenuMonthYear);
	...
	var MONTHYEAR_TRANSITION = 'monthyear';
	...
	var DayPicker = function (_React$Component) {
	  ...
	  function DayPicker(props) {
	    ...
	    _this.handleChangeMonthYearMenu = _this.handleChangeMonthYearMenu.bind(_this);
	  ...
	  _createClass(DayPicker, [{
	    ...
	    value: function () {
	      function updateStateAfterMonthTransition() {
	        ...
	        if (monthTransition === PREV_TRANSITION) {
	          ...
	          newMonth.set({ year: year, month: month - 1 });
	        }
	    ...
	    key: 'handleChangeMonthYearMenu',
	    value: function () {
	      function handleChangeMonthYearMenu(obj) {
	        var _this3 = this;

	        obj.monthTransition = MONTHYEAR_TRANSITION;
	        this.setState(obj, function () {
	          _this3.updateStateAfterMonthTransition();
	        });
	      }

	      return handleChangeMonthYearMenu;
	    }()
	  }, {
	    key: 'render',
	    value: function () {
	      function render() {
	        ...
	        var calendarMonthWidth = _state7.calendarMonthWidth;
	        var currentMonth = _state7.currentMonth;
	        var monthTransition = _state7.monthTransition;
	        var translationValue = _state7.translationValue;
	        var scrollableMonthMultiple = _state7.scrollableMonthMultiple;
	        var focusedDate = _state7.focusedDate;
	        var showKeyboardShortcuts = _state7.showKeyboardShortcuts;
	        var isTouch = _state7.isTouchDevice;
	        ...
	        var verticalHeight = 1.75 * calendarMonthWidth + 50;
	        ...
	        return _react2['default'].createElement('div', {
	          ...
	          focusedDate: focusedDate,
	          phrases: phrases
	        }), verticalScrollable && this.renderNavigation()), _react2['default'].createElement(_MenuMonthYear2['default'], {
	          onMenuChangeYearMonth: this.handleChangeMonthYearMenu,
...
/***/ (function(module, exports) {
	...
	module.exports = require("./MenuMonthYear");
