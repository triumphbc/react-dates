...
var _MenuMonthYear = require('./MenuMonthYear');
    ...
    value: function () {
      function handleChangeMonthYearMenu(obj) {
        ...
        this.setState(obj, function () {
          _this4.updateStateAfterMonthTransition();
        });
      }
    ...
    value: function () {
      function render() {
        ...
        var _state6 = this.state,
            ...
            hasSetHeight = _state6.hasSetHeight,
            calendarInfoWidth = _state6.calendarInfoWidth;
        ...
        return _react2['default'].createElement(
          ...
          }, (0, _reactWithStyles.css)(styles.DayPicker, isHorizontal && styles.DayPicker__horizontal, this.isVertical() && styles.DayPicker__vertical, verticalScrollable && styles.DayPicker__verticalScrollable, isHorizontal && withPortal && styles.DayPicker_portal__horizontal, this.isVertical() && withPortal && styles.DayPicker_portal__vertical, dayPickerStyle, !hasSetHeight && styles.DayPicker__hidden, !noBorder && styles.DayPicker__withBorder)),
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              'div',
              (0, _reactWithStyles.css)(dayPickerWrapperStyle, calendarInfoIsInline && styles.DayPicker_wrapper__horizontal),
              _react2['default'].createElement(
                'div',
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(_MenuMonthYear2['default'], {
                  onMenuChangeYearMonth: this.handleChangeMonthYearMenu,
