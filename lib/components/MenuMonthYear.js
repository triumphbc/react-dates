	  ...
	  _createClass(MenuMonthYear, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        return _react2['default'].createElement('span', { className: 'go-to-date' }, months, years, _react2['default'].createElement('button', { onClick: this.goToToday, type: 'button' }, 'Today'));
	      }
